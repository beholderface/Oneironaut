    ...
    public boolean generate(FeatureContext<BlockVeinConfig> context) {
        ...
        if (/*roll == 8*/ true){
            ...
            for (int i = 0; i < length; i++){
                if ((world.getChunk(carveOrigin).getPos() == world.getChunk(new BlockPos(carve3i)).getPos()) && world.getBlockState(new BlockPos(carve3i)).getBlock() == carvedBlock && carvePoint.y > world.getBottomY()){
