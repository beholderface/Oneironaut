//I stole the original implementation of this from https://github.com/modmuss50/SimpleVoidWorld/blob/1.18/src/main/java/me/modmuss50/svw/VoidChunkGenerator.java
...
public class NoosphereChunkGenerator extends ChunkGenerator {
    private final Registry<Biome> biomeRegistry(){
        return Registry.BIOME_SOURCE.
    }
    public static final Codec<NoosphereChunkGenerator> CODEC = RecordCodecBuilder.create((instance) ->
            method_41042(instance).and(
                            RegistryOps.createRegistryCodec(Registry.BIOME_KEY).forGetter(biomeRegistry)
                    )
                    .apply(instance, instance.stable(NoosphereChunkGenerator::new))
    );



    public NoosphereChunkGenerator(Registry<StructureSet> registry, Registry<Biome> biomeRegistry) {
